...
const (
	reqEndpoint = `https://api.virginatlantic.com/api2/mobile/getPnr`
...
var (
	requestHeaders = map[string]string{
		...
		"Tliosloc":                  "gn=my_trips:find trip_conf_num&ch=find trip_conf_num",
		"Tliosid":                   "15.3, iPad Pro (12.9 inch) 3G (Wi-Fi), 5.14",
		"Content-Type":              "application/xml; charset=utf-8",
		"response-xml":              "true",
		"Accept-Language":           "en-us",
		"Accept-Encoding":           "gzip;q=1.0, compress;q=0.5",
		"User-Agent":                "Virgin Atlantic iPhone, iOS 15.3.1, 5.17, Phone",
	}
